# WorldBorder Legend Discord Role Rules

Because people want to know what exactly you can and can’t do

> Disclaimer: These rules only apply specifically to people trying to get the WorldBorder Legend role on the Komaru Cats Projects discord. They are not the specific hard-set rules for the
> datapack in general.
...
- Give yourself a "second chance" if you are playing Hardcore.
