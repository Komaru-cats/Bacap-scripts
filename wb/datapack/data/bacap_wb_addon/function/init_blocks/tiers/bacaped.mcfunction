...
execute unless score #wb_bacaped_tiers_init wb matches 1 run scoreboard players set #goal wb_tier_blocks 500
execute unless score #wb_bacaped_tiers_init wb matches 1 run scoreboard players set #challenge wb_tier_blocks 1500
execute unless score #wb_bacaped_tiers_init wb matches 1 run scoreboard players set #super_challenge wb_tier_blocks 5000
execute unless score #wb_bacaped_tiers_init wb matches 1 run scoreboard players set #milestone wb_tier_blocks 10000
